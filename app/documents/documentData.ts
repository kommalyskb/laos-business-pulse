...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ວິເຄາະ actor, process, use case, business rule, data flow ແລະ system boundary.", status: "approved", sections: ["Actors and stakeholders", "Use cases and process", "Business rules", "Data flow and boundary"] },
