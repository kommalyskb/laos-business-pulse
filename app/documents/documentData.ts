...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ກຳລັງຂະຫຍາຍຈາກ system context ໄປສູ່ function catalog, workflow, logical ERD, algorithm ແລະ developer handoff.", status: "in_progress", sections: ["System context and rules", "Functional decomposition", "Workflow and algorithms", "Logical data model and developer handoff"] },
