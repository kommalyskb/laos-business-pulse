...
export const documents: ProjectDocument[] = [
  ...
  { slug: "prd", code: "PRO-01", title: "ຂໍ້ກຳນົດຜະລິດຕະພັນ", english: "Product Requirements Document", category: "product", summary: "ແປ product vision ໃຫ້ເປັນ feature, user story, priority ແລະຜົນທີ່ວັດແທກໄດ້.", status: "draft", sections: ["Goals and users", "MVP feature scope", "User stories", "Success and acceptance"] },
