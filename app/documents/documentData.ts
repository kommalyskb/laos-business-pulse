...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ຂັ້ນ 1–3 ຈັດເຮັດແລ້ວ: 64 Functions, 27 Entities/43 Relationships ແລະ 16 End-to-end Workflows; ຂັ້ນຖັດໄປແມ່ນ Function Specification & Algorithm.", status: "in_progress", sections: ["System context and rules", "Functional decomposition and catalog", "Logical data model and ERD", "Workflow, algorithms and developer handoff"] },
