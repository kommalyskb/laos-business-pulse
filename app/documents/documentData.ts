...
export const documents: ProjectDocument[] = [
  ...
  { slug: "market-competitor", code: "BUS-02", title: "ຕະຫຼາດ ແລະ ຄູ່ແຂ່ງ", english: "Market & Competitor Analysis", category: "business", summary: "ວິເຄາະພຶດຕິກຳຜູ້ໃຊ້, ທາງເລືອກເດີມ ແລະຊ່ອງວ່າງຂອງຕະຫຼາດລາວ.", status: "draft", sections: ["User behavior", "Direct and indirect competitors", "Market gap", "Risks and assumptions"] },
