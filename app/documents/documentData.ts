...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ສະບັບ 0.9 ພ້ອມທົບທວນ: 7 ຂັ້ນຂອງ SA ຈັດເຮັດຄົບ ແລະເຊື່ອມ 13 Requirements ຫາ 64 Functions, 27 Entities, 16 Workflows, 7 State Machines, 30 Error Codes ແລະ 9 Work Packages ສຳລັບ Developer Handoff.", status: "in_progress", sections: ["System context and rules", "Function, data, workflow and algorithm", "State, error and traceability", "Development starting point and dependency order"] },
