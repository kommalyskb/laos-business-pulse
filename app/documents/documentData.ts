...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ຂັ້ນ 1–6 ຈັດເຮັດແລ້ວ: Traceability ເຊື່ອມ PRO-01 13 Requirements ຄົບຫາ 64 Functions, 27 Entities, 16 Workflows, 7 State Machines ແລະ 30 Error Codes. ຂັ້ນຖັດໄປແມ່ນ Development Starting Point & Dependency Order.", status: "in_progress", sections: ["System context and rules", "Functional decomposition and data model", "Workflow, state and error handling", "Full requirement traceability"] },
