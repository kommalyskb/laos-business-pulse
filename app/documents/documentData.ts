...
export const documents: ProjectDocument[] = [
  ...
  { slug: "mvp-scope", code: "PRO-03", title: "ຂອບເຂດ MVP", english: "MVP Scope & Prioritization", category: "product", summary: "ຮ່າງ 0.1 ກຳນົດຂອບເຂດ Validation Pilot ແລະ Public MVP ໂດຍແຍກ 31 ລາຍການເປັນ Must, Should, Later ແລະ Out; ພ້ອມຂອບເຂດ Manual Operation, Release Gates ແລະກົດຄວບຄຸມ Scope Change.", status: "draft", sections: ["Pilot baseline and priority policy", "M0–M3 milestone boundary", "31-item scope catalog", "Manual operation and release gates"] },
