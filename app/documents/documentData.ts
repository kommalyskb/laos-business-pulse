...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ຂັ້ນ 1–4 ຈັດເຮັດແລ້ວ: 64 Functions ມີ Data Model, Workflow ແລະ Function Specification/Algorithm ຄົບ 1:1; ຂັ້ນຖັດໄປແມ່ນ State Transition & Error Handling.", status: "in_progress", sections: ["System context and rules", "Functional decomposition and catalog", "Logical data model and ERD", "Workflow, algorithms and developer handoff"] },
