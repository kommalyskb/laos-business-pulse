...
export const documents: ProjectDocument[] = [
  ...
  { slug: "financial-structure", code: "BUS-05", title: "ໂຄງສ້າງການເງິນ", english: "Financial Structure (FS)", category: "business", summary: "ກຳນົດທຶນເລີ່ມຕົ້ນ, ລາຍຈ່າຍ, cash flow, runway, break-even ແລະແຜນລະດົມທຶນ.", status: "draft", sections: ["Capital structure", "Cost and cash flow", "Revenue scenarios", "Runway and break-even"] },
