...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "Functional Decomposition ແລະ Function Catalog 10 Modules/64 Functions ຈັດເຮັດແລ້ວ; ຂັ້ນຖັດໄປແມ່ນ Logical Data Model ແລະ ERD.", status: "in_progress", sections: ["System context and rules", "Functional decomposition and catalog", "Logical data model and ERD", "Workflow, algorithms and developer handoff"] },
