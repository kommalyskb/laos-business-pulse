...
export const documents: ProjectDocument[] = [
  ...
  { slug: "mvp-scope", code: "PRO-03", title: "ຂອບເຂດ MVP", english: "MVP Scope & Prioritization", category: "product", summary: "ຮ່າງ 0.2 ກຳນົດວ່າລະບົບສະບັບທຳອິດຈະສ້າງຫຍັງ, ຍັງບໍ່ສ້າງຫຍັງ, ຄວນພັດທະນາຕາມລຳດັບໃດ ແລະຕ້ອງມີຫຼັກຖານແບບໃດຈຶ່ງຂະຫຍາຍຕໍ່.", status: "draft", sections: ["Purpose and first-version overview", "User journey and build scope", "Deferred features and development order", "Detailed priority catalog and release gates"] },
