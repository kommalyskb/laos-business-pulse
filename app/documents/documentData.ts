...
export const documents: ProjectDocument[] = [
  ...
  { slug: "revenue-kpi", code: "BUS-06", title: "ລາຍຮັບ ແລະ ຕົວຊີ້ວັດ", english: "Revenue Model & KPI", category: "business", summary: "ຜູກຮູບແບບລາຍຮັບກັບ metric ທີ່ພິສູດວ່າ platform ພາຄົນໄປສູ່ການຕັດສິນໃຈ.", status: "draft", sections: ["Revenue streams", "North-star metric", "Funnel metrics", "Reporting cadence"] },
