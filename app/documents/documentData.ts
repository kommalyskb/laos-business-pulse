...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ຂັ້ນ 1–2 ຈັດເຮັດແລ້ວ: 10 Modules/64 Functions ແລະ Logical Data Model 27 Entities/43 Relationships; ຂັ້ນຖັດໄປແມ່ນ Workflow/Sequence.", status: "in_progress", sections: ["System context and rules", "Functional decomposition and catalog", "Logical data model and ERD", "Workflow, algorithms and developer handoff"] },
