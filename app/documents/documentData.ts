...
export const documents: ProjectDocument[] = [
  ...
  { slug: "system-analysis", code: "PRO-02", title: "ການວິເຄາະລະບົບ", english: "System Analysis (SA)", category: "product", summary: "ຂັ້ນ 1–5 ຈັດເຮັດແລ້ວ: 64 Functions ມີ Data Model, Workflow, Function Specification/Algorithm ແລະ Error Policy ຄົບ; 7 State Machines ກຳນົດ Transition/Guard ແລ້ວ. ຂັ້ນຖັດໄປແມ່ນ Traceability Matrix.", status: "in_progress", sections: ["System context and rules", "Functional decomposition and catalog", "Logical data model and ERD", "Workflow, state and error handling"] },
