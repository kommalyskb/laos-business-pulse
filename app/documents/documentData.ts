...
export const documents: ProjectDocument[] = [
  ...
  { slug: "business-canvas", code: "BUS-03", title: "ແຜນພາບທຸລະກິດ", english: "Business Model Canvas", category: "business", summary: "ສະຫຼຸບ customer segment, value, channel, partner, cost ແລະ revenue ໄວ້ໃນໜ້າດຽວ.", status: "draft", sections: ["Customer segments", "Value and channels", "Key activities and partners", "Cost and revenue"] },
  ...
  { slug: "financial-structure", code: "BUS-05", title: "ໂຄງສ້າງການເງິນ", english: "Financial Structure (FS)", category: "business", summary: "ກຳນົດທຶນເລີ່ມຕົ້ນ, ລາຍຈ່າຍ, cash flow, runway, break-even ແລະແຜນລະດົມທຶນ.", status: "next", sections: ["Capital structure", "Cost and cash flow", "Revenue scenarios", "Runway and break-even"] },
  { slug: "revenue-kpi", code: "BUS-06", title: "ລາຍຮັບ ແລະ ຕົວຊີ້ວັດ", english: "Revenue Model & KPI", category: "business", summary: "ຜູກຮູບແບບລາຍຮັບກັບ metric ທີ່ພິສູດວ່າ platform ພາຄົນໄປສູ່ການຕັດສິນໃຈ.", status: "planned", sections: ["Revenue streams", "North-star metric", "Funnel metrics", "Reporting cadence"] },
