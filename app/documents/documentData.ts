...
export const documents: ProjectDocument[] = [
  ...
  { slug: "feasibility-study", code: "BUS-04", title: "ການສຶກສາຄວາມເປັນໄປໄດ້", english: "Feasibility Study", category: "business", summary: "ປະເມີນຄວາມເປັນໄປໄດ້ດ້ານຕະຫຼາດ, content, ເຕັກນິກ, ການເງິນ ແລະກົດໝາຍ.", status: "draft", sections: ["Market feasibility", "Operational feasibility", "Technical feasibility", "Go / no-go criteria"] },
