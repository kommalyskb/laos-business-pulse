...
function Header({ code, title, lao }: { code: string; title: string; lao: string }) {
  return <header className={styles.formalDocumentHeader}><p>{code} · DELIVERY &amp; OPERATIONS · 30 AUGUST 2026</p><h1>{title}</h1><h2>{lao}</h2><span className={`${styles.formalStatus} ${styles.formalDraftStatus}`}>0.3 · Capacity/Authority ອະນຸມັດ · External checkpoints VACANT · Execution evidence ຍັງຄົງຄ້າງ</span></header>;
}
