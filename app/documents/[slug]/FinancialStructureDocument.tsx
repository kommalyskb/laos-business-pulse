    ...
    <article className={`${styles.detailBody} ${styles.financialBody}`}>
      ...
      <section>
        ...
        <ol className={styles.openQuestions}>
          ...
          <li><b>03</b><p>ລາຍຈ່າຍຄົງທີ່ ແລະລາຍຈ່າຍຜັນແປຕົວຈິງ ຫຼັງຈາກໄດ້ໃບສະເໜີລາຄາສຳລັບວຽກເຕັກນິກ, ຂໍ້ມູນ, ການເດີນທາງ, ເຄື່ອງມື ແລະການບັນຊີ.</p></li>
        </ol>
      </section>

      <aside className={styles.approvalGate}>
        <div><span>ຍັງບໍ່ພ້ອມສຳລັບ 1.0</span><h2>ໂຄງສ້າງການເງິນ 0.2</h2></div>
        <ul><li>ກົດການເງິນ — ອະນຸມັດແລ້ວ</li><li>ເພດານງົບຕົວຈິງ — ລໍຖ້າ</li><li>ຄ່າຄອງຊີບຜູ້ກໍ່ຕັ້ງ — ລໍຖ້າ</li><li>ລາຍຈ່າຍຈາກໃບສະເໜີລາຄາ — ລໍຖ້າ</li></ul>
      </aside>
