...
const documents: Partial<Record<"BUS-01" | "BUS-02" | "BUS-03" | "BUS-04" | "BUS-05" | "BUS-06", DocumentDetail>> = {
  ...
  "BUS-02": {
    ...
    introduction: [
      ...
      "ສະບັບ 0.1 ຍັງເປັນ Market thesis ທີ່ອີງໃສ່ Founder observation. ຂໍ້ຄວາມຈຶ່ງແຍກສິ່ງທີ່ສັງເກດເຫັນອອກຈາກສິ່ງທີ່ Pilot ຕ້ອງພິສູດ.",
    ],
    sections: [
      ...
      { id:"bus02-proof", label:"11–13 · RISKS, EVIDENCE & REVIEW", title:"ສິ່ງທີ່ອາດເຮັດໃຫ້ Market thesis ຜິດ", question:"ຫຼັກຖານໃດຈະຊ່ວຍອະນຸມັດ ຫຼືປະຕິເສດຂໍ້ສັນນິຖານ?", paragraphs:["ຄວາມສ່ຽງຫຼັກຄື User ອາດພໍໃຈກັບ Social search ເດີມ, ຂໍ້ມູນອາດບໍ່ພໍ, User ອາດເບິ່ງວິດີໂອແຕ່ບໍ່ກົດໄປຮ້ານ, ແລະຮ້ານອາດບອກວ່າສົນໃຈແຕ່ບໍ່ຈ່າຍ.","ຫຼັກຖານຕ້ອງເກັບຈາກ Task test, Funnel event, ຈຳນວນ Place ທີ່ກວດແລ້ວ, ເວລາດູແລຂໍ້ມູນ, ການໃຊ້ຊ້ຳ ແລະ Payment/deposit. ຄຳຊົມ, Like ແລະຄຳວ່າ “ຈະໃຊ້” ບໍ່ຄວນໃຊ້ແທນພຶດຕິກຳຈິງ."], implications:["BUS-02 ຍັງຄົງສະຖານະ Draft ຈົນກວ່າຈະມີ User test ແລະ Competitor evidence", "ຜົນ Pilot ອາດພາໄປສູ່ Go, Adjust ຫຼື No-go", "ຕ້ອງບັນທຶກວັນທີ, ແຫຼ່ງທີ່ມາ ແລະຂໍ້ຈຳກັດຂອງຫຼັກຖານ"] },
    ],
  },
  "BUS-04": {
