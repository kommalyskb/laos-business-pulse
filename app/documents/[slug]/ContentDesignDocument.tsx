  ...
  "full-ux-ui": {
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery 0.11.0", "SCR-G01/G02/G03/G05 ໃຊ້ Guest Prototype R2.3; SCR-A00—A09 embed Admin Workflow Prototype R5.0 ໂດຍກົງ", "Admin ກວດ Application Launcher → Module → Header Sub-Menu → task-first Content intake → functional workspace", "Design handoff ready; technical implementation pending"],
        ["Admin Workflow Prototype R5.0", "Standalone /admin-prototype ພ້ອມ 10 Main Modules, 55 views, guided intake, readable controls ແລະ session persistence", "ລອງ workflow, custom dropdown ດ້ວຍ mouse/keyboard/touch, responsive view ແລະ refresh session state", "Interaction and accessibility baseline ready"],
        ["Navigation & Control Contract", "Main Modules ເລືອກຜ່ານ Application Launcher; Header ສະແດງສະເພາະ Sub-Menu ຂອງ active Module; Dropdown ສະແດງ label, metadata ແລະ selected state", "ກວດ URL module/view, keyboard navigation, focus, touch target ແລະ mobile bottom sheet", "R5.0 baseline ready"],
      ...
      , ["Custom dropdown", "Form/filter/role/invoice/export controls", "label + metadata, selected check, Arrow/Home/End/Enter/Escape, outside click ແລະ mobile bottom sheet", "Prototype component; TEC-02 ຕ້ອງກຳນົດ data source"],
        ["Readable typography", "table, form, modal, dashboard, status ແລະ navigation", "caption ≥12px; working text 13–14px; section heading ≥16px; Lao line-height 1.5–1.65", "Manual 200% zoom/assistive-tech gate pending"]
      ], note: "R5.0 ເປັນ interaction/design handoff evidence ສຳລັບ Architecture ແລະ Frontend estimation; ບໍ່ແມ່ນ production system ແລະບໍ່ແທນ System Analysis/API/Auth specification."},
