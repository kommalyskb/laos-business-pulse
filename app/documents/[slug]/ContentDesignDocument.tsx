...
const specs: Record<string, DocumentSpec> = {
  ...
  "full-ux-ui": {
    ...
    version: "0.9.0", status: "pending", statusLabel: "Guest Prototype R2.3 + Admin Workflow Prototype R3.0 ສຳເລັດ · ລໍ Backend/Auth/Failure-state/Manual Gates ກ່ອນ 1.0",
    approvalNote: "ສະບັບ 0.9.0 ຖອນຄວາມໝາຍວ່າ static Admin Gallery ເປັນ prototype ທີ່ພ້ອມໃຊ້ ແລະປ່ຽນເປັນ standalone Admin Workflow Prototype R3.0. Prototype ໃໝ່ຄຸ້ມ 10 Modules: Executive Overview, Operations Queue, Place 360, Content & Sources, Trust & Safety, Partner CRM, Sponsored Campaigns, Analytics, Revenue & Finance ແລະ System & Access. Interaction ທີ່ທົດລອງໄດ້ລວມ search, quick create, select/drill-down record, assign, edit, workflow advance, submit/review/publish, trust decision + audit, Partner/Campaign stage transition, Finance evidence verification, role change, feature flag ແລະ cross-module navigation. Data ແລະ Audit ເປັນ session fixtures ເທົ່ານັ້ນ; ຍັງບໍ່ມີ backend, authentication, durable persistence ຫຼື production permission enforcement. Odoo ໃຊ້ສະເພາະ information architecture/interaction anatomy; ສີ, Noto Sans Lao Variable, semantic states, border ແລະ focus style ໃຊ້ UX-04 Design Tokens. UX-05 ຍັງບໍ່ແມ່ນ 1.0 ຈົນ TEC-01/02, exhaustive failure states, Manual Accessibility Gates ແລະ final four-role sign-off ສຳເລັດ.",
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery 0.9.0", "SCR-G01/G02/G03/G05 ໃຊ້ Guest Prototype R2.3; SCR-A00—A09 embed Admin Workflow Prototype R3.0 ໂດຍກົງ", "Guest ກວດຈາກ live source; Admin ກວດ full-screen route, 10 Modules, create/edit/transition/approve/audit ແລະ cross-module drill-down", "Interactive baseline ready; backend/auth pending"],
        ["Admin Workflow Prototype R3.0", "Standalone /admin-prototype ພ້ອມ session fixtures ແລະ 7 core operating workflows", "ລອງ Search, Quick Create, Queue→Record, Place Publish, Content Advance, Trust Decision, Partner/Campaign Advance, Finance Verify, Role/Flag Change", "High-fidelity interaction prototype ready"],
      ...
      { title: "Approval Gates ແລະ Sign-off", intro: "UX-05 1.0 ແມ່ນຄຳຢືນຢັນວ່າ package ພ້ອມໃຫ້ Developer ສ້າງໂດຍບໍ່ເດົາ. ການມີຮູບ Happy path ສວຍງາມບໍ່ພຽງພໍ.", headers: ["Gate", "ຕ້ອງມີ", "Signer", "ສະຖານະ"], rows: [
        ...
        ["G-UX6 Final handoff", "final screens, responsive/state variants, assets, copy, annotations, open deviations", "Product Owner + Frontend Lead", "Admin Workflow R3.0 interactive baseline ready; backend/auth/exhaustive states and final four-role sign-off pending"]
