...
const specs: Record<string, DocumentSpec> = {
  ...
  "interactive-prototype": {
    ...
    sections: [
      { title: "ເລີ່ມຈາກນີ້ · ສະຖານະ ແລະວຽກຕໍ່ໄປ", intro: "Founder Review R2 ສຳເລັດແລ້ວ. ຕາຕະລາງນີ້ບອກວ່າອັນໃດສຳເລັດ ແລະອັນໃດຍັງລໍ.", headers: ["ລຳດັບ", "ວຽກ", "ຜົນ", "ສະຖານະ"], rows: [
        ...
        ["3", "Internal Browser QA ແລະ Retest", "Prototype R2.3 ຜ່ານ deterministic states, core flow, fallback, responsive layout, semantic audit, focus restoration, touch target ແລະ console check", "ສຳເລັດ · ມີ evidence JSON"],
        ["4", "Formative test ກັບຜູ້ໃຊ້ພາຍນອກ 5 ຄົນ", "ໃຊ້ Prototype R2.3 ແລະຊຸດແບບຟອມທີ່ກຽມໄວ້", "ຍັງບໍ່ເລີ່ມ"]
      ], note: "Internal QA ຢືນຢັນວ່າ Prototype ພ້ອມສຳລັບຮອບທົດສອບຜູ້ໃຊ້. ຂັ້ນຕໍ່ໄປຄື recruit ຜູ້ໃຊ້ 5 ຄົນ, ທົດສອບ T-01—T-05 ແລະບັນທຶກ behavior ຈິງ; ຫ້າມນັບ Internal Browser QA ແທນ external usability evidence."},
      ...
      { title: "Formative Round 1 · ແຜນປະຕິບັດ 5 ຄົນ", intro: "ຮອບນີ້ເນັ້ນຫາບັນຫາຫຼັກກ່ອນ validation 20 ຄົນ. ຕ້ອງ recruit ຜູ້ໃຊ້ຈິງ; ການກວດດ້ວຍ Browser ຫຼືທີມພັດທະນາບໍ່ນັບເປັນ participant.", headers: ["ລຳດັບ", "ການດຳເນີນງານ", "ຜູ້ຮັບຜິດຊອບ", "ຫຼັກຖານ/Exit"], rows: [
        ...
        ["F-06 Status boundary", "ຊຸດເອກະສານ ແລະ Prototype R2.3 ຜ່ານ Internal QA ແລະພ້ອມສຳລັບ recruitment ແຕ່ຍັງບໍ່ມີ real-user result.", "Product Owner", "UX-03 ຄົງ 0.9.4 ຈົນ evidence ແລະ pass gate ຄົບ"]
      ]}
    ],
  ...
  "design-system": {
    ...
    sections: [
      ...
      { title: "Pilot Component Catalog", intro: "ລາຍການນີ້ກົງກັບ Prototype R2.3. ແຕ່ລະ Component ຕ້ອງອ້າງ Place ID ຫຼື Search State ດຽວກັນ ເພື່ອບໍ່ໃຫ້ Video, List ແລະ Map ສະແດງຂໍ້ມູນຂັດກັນ.", headers: ["ID / Component", "ໜ້າທີ່", "ຂໍ້ມູນ/ສ່ວນປະກອບ", "ພຶດຕິກຳ ແລະເກນຮັບມອບ"], rows: [
      ...
      { title: "Internal Browser QA · Findings ແລະ Retest", intro: "ການກວດຮອບ QA-20260828-INT-01 ປຽບທຽບ Public R2.2 ກັບ Local R2.3. ມັນເປັນຫຼັກຖານ Technical/Internal QA; ບໍ່ແທນ VoiceOver, Physical Keyboard, Browser Zoom 200%, OS Reduced Motion ຫຼື external usability test.", headers: ["Finding", "ບັນຫາທີ່ພົບ", "ການແກ້", "Retest"], rows: [
        ["QA-F01", "Search accessible name ລວມຄຳຂອງປຸ່ມ Clear ເພາະ label ຫຸ້ມທັງສອງ control", "ໃສ່ aria-label ພາສາລາວໂດຍກົງໃຫ້ Search input", "Passed"],
        ["QA-F02", "View ແລະ Filter ບໍ່ປະກາດ selected state", "ເພີ່ມ aria-pressed ແລະ Lao aria-label ໃຫ້ Intent, Category, View ແລະ Bottom Navigation", "Passed"],
        ["QA-F03", "ບາງ control ສູງ 32—42px ຕ່ຳກວ່າ Touch Contract 44px", "ປັບ Intent Chip, View Switcher, Map Marker, Section Action, Prototype Link ແລະ QA Control ເປັນຢ່າງໜ້ອຍ 44px", "Passed"],
        ["QA-F04", "ປິດ QA panel ແລ້ວ Focus ບໍ່ມີສັນຍາກັບຄືນທີ່ແນ່ນອນ", "ເປີດແລ້ວ Focus ໄປ Close; ປິດດ້ວຍ Close/Escape ແລ້ວກັບຄືນ QA trigger ພ້ອມ outline 3px", "Passed"]
      ]},
      { title: "Accessibility QA Evidence · 28 Aug 2026", intro: "ຕາຕະລາງນີ້ແຍກສິ່ງທີ່ Internal Browser QA ກວດຜ່ານແລ້ວອອກຈາກ Manual Accessibility Gate ທີ່ຍັງຕ້ອງກວດດ້ວຍຄົນ ແລະອຸປະກອນຈິງ.", headers: ["QA ID", "ການກວດ", "ຜົນ", "ສະຖານະ"], rows: [
  ...
  "full-ux-ui": {
    ...
    version: "0.10.0", status: "pending", statusLabel: "Guest Prototype R2.3 + Admin Workflow Prototype R4.0 ສຳເລັດ · ລໍ Backend/Auth/Failure-state/Manual Gates ກ່ອນ 1.0",
    approvalNote: "ສະບັບ 0.10.0 ຍົກ Admin Workflow Prototype ເປັນ R4.0: 10 Main Modules—Executive Overview, Operations Queue, Place 360, Content & Sources, Trust & Safety, Partner CRM, Sponsored Campaigns, Analytics, Revenue & Finance ແລະ System & Access—ເລືອກຜ່ານ Application Launcher; Header ສະແດງສະເພາະ Sub-Menu ຂອງ Module ປັດຈຸບັນ. 55 views ບໍ່ແມ່ນ static placeholder ອີກ: ທຸກໜ້າມີ purpose/start/done guidance, KPI, filterable register, view-specific create action, owner, due date, workflow transition, business control, required evidence, checklist, activity/audit, CSV export ແລະ browser-session persistence. ຮູບແບບວຽກສະເພາະປະກອບມີ register, board, calendar, analytics, control matrix, finance scenario ແລະ CSV import validation. Data ແລະ Audit ຍັງເປັນ prototype fixtures; ຍັງບໍ່ມີ backend, authentication, durable persistence, real integrations ຫຼື production permission enforcement. UX-05 ຍັງບໍ່ແມ່ນ 1.0 ຈົນ TEC-01/02, exhaustive failure states, Manual Accessibility Gates ແລະ final four-role sign-off ສຳເລັດ.",
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery 0.10.0", "SCR-G01/G02/G03/G05 ໃຊ້ Guest Prototype R2.3; SCR-A00—A09 embed Admin Workflow Prototype R4.0 ໂດຍກົງ", "Admin ກວດ Application Launcher → Module → Header Sub-Menu → functional workspace ແລະ audit", "Interactive baseline ready; backend/auth pending"],
        ["Admin Workflow Prototype R4.0", "Standalone /admin-prototype ພ້ອມ 10 Main Modules ແລະ 55 functional Sub-Menu views", "ລອງ create, filter, assign, checklist, evidence, workflow transition, export/import ແລະ refresh session state", "High-fidelity functional prototype ready"],
        ["Single-level Header Navigation", "Main Modules ບໍ່ສະແດງໃນ Header; Header Menu ສະແດງ Sub-Menu ຂອງ active Module ໂດຍກົງ", "ປ່ຽນ Module ຜ່ານ Application Launcher ແລ້ວກວດ Sub-Menu context ແລະ URL module/view", "R4.0 baseline ready"],
        ["Screen Specification", "Purpose, route, data, state, interaction ແລະ acceptance ຂອງ 4 Guest Screens ແລະ 10 Admin Modules", "ພຣີວິວ JSON ຈາກໜ້າເອກະສານ", "Baseline ready"],
      ...
      { title: "Admin R4.0 Functional Coverage", intro: "Prototype ໃຊ້ workspace mode ທີ່ຕົງກັບວຽກແຕ່ລະປະເພດ ແທນການໃຊ້ table ຮູບແບບດຽວທຸກໜ້າ.", headers: ["Workspace mode", "ໃຊ້ກັບ", "Interaction ທີ່ທົດລອງໄດ້", "Boundary"], rows: [
        ...
        ["Workflow board", "all work, SLA, automation, publishing, appeal, renewal, creative", "ເບິ່ງ state columns, select record ແລະ advance workflow", "ບໍ່ມີ backend queue"],
        ["Calendar", "partner activity, campaign calendar, deployment", "schedule card, owner/readiness ແລະ record detail", "ບໍ່ sync external calendar"],
        ["Analytics", "report, health, source coverage, performance, analytics, integration, audit", "metric drill-down, definition/control ແລະ CSV export", "Synthetic metrics"],
        ["Control matrix", "category, policy, reason code, role, record rule, feature flag", "toggle requirement/visibility/enforcement ແລະ audit simulation", "Backend enforcement pending"],
        ["Finance scenario", "billing, payments, invoices, expenses, budget gates, runway", "ປ້ອນ cash/cost/verified revenue ແລະຄຳນວນ runway", "No accounting integration"],
        ["Import validation", "Place import/export ແລະ analytics export", "CSV preview up to 5 rows, validation queue, export ແລະ rollback boundary", "No live overwrite"]
      ], note: "R4.0 ເປັນ interaction/design evidence ສຳລັບພັດທະນາ; ບໍ່ແມ່ນ production system ແລະບໍ່ແທນ System Analysis/API/Auth specification."},
      { title: "Final Screen Inventory", intro: "Screen ທີ່ລະບຸເປັນ Must ຕ້ອງມີ mobile final design, responsive rule, state set ແລະ annotation.", headers: ["Screen ID", "Screen", "Priority", "Required deliverables"], rows: [
        ...
        ["SCR-A00", "Executive Overview", "Admin Core", "360° KPI, global filters, drill-down, attention, pipeline, runway"],
        ["SCR-A01", "Operations Queue", "Admin Core", "SLA/filter/group/assignment/empty/error"],
        ["SCR-A02", "Place 360 & Editor", "Admin Core", "field/source/readiness/performance/partner/audit/conflict"],
        ["SCR-A03", "Trust & Safety", "Admin Core", "report/evidence/policy/decision/appeal timeline"],
        ["SCR-A04", "Content & Sources", "Admin Core", "intake/rights/classification/place-match/freshness/publish"],
        ["SCR-A05", "Partners", "Admin Expansion", "lead/pilot/payment/activity/performance/renewal Kanban"],
        ["SCR-A06", "Campaigns", "Admin Expansion", "sponsored compliance/creative/flight/delivery/payment"],
        ["SCR-A07", "Analytics", "Admin Core", "global filter/funnel/trend/place contribution/drill-down"],
        ["SCR-A08", "Revenue & Finance", "Admin Core", "verified revenue/expense/living cost/budget gate/runway"],
        ["SCR-A09", "System & Access", "Admin Core", "role/record rule/integration/feature flag/health/audit"]
      ]},
      ...
      { title: "Approval Gates ແລະ Sign-off", intro: "UX-05 1.0 ແມ່ນຄຳຢືນຢັນວ່າ package ພ້ອມໃຫ້ Developer ສ້າງໂດຍບໍ່ເດົາ. ການມີຮູບ Happy path ສວຍງາມບໍ່ພຽງພໍ.", headers: ["Gate", "ຕ້ອງມີ", "Signer", "ສະຖານະ"], rows: [
        ...
        ["G-UX6 Final handoff", "final screens, responsive/state variants, assets, copy, annotations, open deviations", "Product Owner + Frontend Lead", "Admin Workflow R4.0 Application Launcher + 55 functional views ready; backend/auth/exhaustive states and final four-role sign-off pending"]
