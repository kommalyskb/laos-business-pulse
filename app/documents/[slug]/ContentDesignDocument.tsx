...
const specs: Record<string, DocumentSpec> = {
  ...
  "full-ux-ui": {
    ...
    version: "0.8.1", status: "pending", statusLabel: "Guest/Pilot Parity + Odoo-inspired Admin Business Operations Portal R2.1 ສຳເລັດ · ລໍ Technical/Manual Gates ກ່ອນ 1.0",
    approvalNote: "ສະບັບ 0.8.1 ຮັກສາ Prototype R2.3 ເປັນແຫຼ່ງອອກແບບດຽວຂອງ Guest/Pilot ແລະຮັກສາຂອບເຂດ Admin Business Operations Portal 360° ຈຳນວນ 10 Modules. ຫຼັງ Founder Review ພົບ design drift ວ່າ R2.0 ຍັງເບິ່ງຄື generic SaaS dashboard, R2.1 ຈຶ່ງຮື້ dark sidebar ອອກ ແລະປັບ visual anatomy ໃຫ້ໃກ້ Odoo 19 ຂຶ້ນຢ່າງຊັດເຈນ: mauve top application bar, horizontal module menus, record control panel, search/filter/group/view/pager, full workspace app launcher, list/kanban/form/report surfaces ແລະ activity/audit context. ຍັງຄົງໃຊ້ brand, ພາສາ ແລະ data contract ຂອງພ້ອມໄປເອງ. ເອກະສານຍັງບໍ່ແມ່ນ 1.0: TEC-01/02, UI-impact legal/privacy decisions, Physical Keyboard, VoiceOver, actual Zoom 200%, OS Reduced Motion ແລະ final four-role sign-off ຍັງຕ້ອງສຳເລັດ.",
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery R2.1", "SCR-G01/G02/G03/G05 ໃຊ້ Prototype R2.3; SCR-A00—A09 ໃຊ້ Odoo-inspired Admin Business Operations Portal", "Guest ກວດຈາກ live Prototype source; Admin ກວດ horizontal app bar, 10 Modules, Viewport, State, full App Launcher ແລະ cross-module navigation", "Guest parity + Admin Portal R2.1 ready"],
      ...
      { title: "Approval Gates ແລະ Sign-off", intro: "UX-05 1.0 ແມ່ນຄຳຢືນຢັນວ່າ package ພ້ອມໃຫ້ Developer ສ້າງໂດຍບໍ່ເດົາ. ການມີຮູບ Happy path ສວຍງາມບໍ່ພຽງພໍ.", headers: ["Gate", "ຕ້ອງມີ", "Signer", "ສະຖານະ"], rows: [
        ...
        ["G-UX6 Final handoff", "final screens, responsive/state variants, assets, copy, annotations, open deviations", "Product Owner + Frontend Lead", "Odoo-inspired Admin Portal R2.1 baseline ready; final four-role sign-off pending"]
