...
const specs: Record<string, DocumentSpec> = {
  ...
  "full-ux-ui": {
    ...
    version: "0.8.2", status: "pending", statusLabel: "Guest/Pilot Parity + Admin Business Operations Portal R2.2 ສຳເລັດ · ລໍ Technical/Manual Gates ກ່ອນ 1.0",
    approvalNote: "ສະບັບ 0.8.2 ຮັກສາ Prototype R2.3 ເປັນແຫຼ່ງອອກແບບດຽວຂອງ Guest/Pilot ແລະຮັກສາຂອບເຂດ Admin Business Operations Portal 360° ຈຳນວນ 10 Modules. Admin R2.2 ໃຊ້ Odoo 19 ສະເພາະເປັນແບບອ້າງອີງດ້ານ information architecture ແລະ interaction anatomy: horizontal application bar, module menus, record control panel, search/filter/group/view/pager, full workspace launcher, list/kanban/form/report surfaces ແລະ activity/audit context. ສີ, font, semantic states, border ແລະ focus style ຕ້ອງໃຊ້ UX-04 Design Tokens: Noto Sans Lao Variable, Primary #17644F, Accent #F27A45 ພ້ອມ on-accent #17221F ແລະ semantic colors ທີ່ອະນຸມັດ; ບໍ່ນຳ Odoo palette ມາໃຊ້. ເອກະສານຍັງບໍ່ແມ່ນ 1.0: TEC-01/02, UI-impact legal/privacy decisions, Physical Keyboard, VoiceOver, actual Zoom 200%, OS Reduced Motion ແລະ final four-role sign-off ຍັງຕ້ອງສຳເລັດ.",
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery R2.2", "SCR-G01/G02/G03/G05 ໃຊ້ Prototype R2.3; SCR-A00—A09 ໃຊ້ Admin Business Operations Portal ທີ່ມີ Odoo-inspired structure ແລະ UX-04 visual tokens", "Guest ກວດຈາກ live Prototype source; Admin ກວດ horizontal app bar, 10 Modules, Viewport, State, full App Launcher, cross-module navigation ແລະ token conformity", "Guest parity + Admin Portal R2.2 ready"],
      ...
      { title: "Approval Gates ແລະ Sign-off", intro: "UX-05 1.0 ແມ່ນຄຳຢືນຢັນວ່າ package ພ້ອມໃຫ້ Developer ສ້າງໂດຍບໍ່ເດົາ. ການມີຮູບ Happy path ສວຍງາມບໍ່ພຽງພໍ.", headers: ["Gate", "ຕ້ອງມີ", "Signer", "ສະຖານະ"], rows: [
        ...
        ["G-UX6 Final handoff", "final screens, responsive/state variants, assets, copy, annotations, open deviations", "Product Owner + Frontend Lead", "Admin Portal R2.2 baseline ready; Odoo structure + UX-04 tokens recorded; final four-role sign-off pending"]
