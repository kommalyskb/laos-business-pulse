...
const specs: Record<string, DocumentSpec> = {
  ...
  "full-ux-ui": {
    ...
    version: "0.7.1", status: "pending", statusLabel: "Guest/Pilot Prototype Parity ສຳເລັດ · ລໍ Technical/Manual Gates ກ່ອນ 1.0",
    approvalNote: "ສະບັບ 0.7.1 ແກ້ Guest/Pilot Design Drift ຕາມຜົນທົບທວນຂອງ Product Owner: Final Design Gallery ບໍ່ສ້າງ Guest UI ສຳເນົາແຍກອີກ ແຕ່ສະແດງ Prototype R2.3 ໂດຍກົງຕາມ Screen ແລະ State. Prototype ຈຶ່ງເປັນແຫຼ່ງອອກແບບດຽວຂອງ SCR-G01/G02/G03/G05; Admin SCR-A01/A02/A03 ຍັງເປັນ UX-05-specific design. ເອກະສານຍັງບໍ່ແມ່ນ 1.0: TEC-01/02, UI-impact legal/privacy decisions, Physical Keyboard, VoiceOver, actual Zoom 200%, OS Reduced Motion ແລະ final four-role sign-off ຍັງຕ້ອງສຳເລັດ.",
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery R1.1", "SCR-G01/G02/G03/G05 ໃຊ້ Prototype R2.3 ໂດຍກົງ; SCR-A01/A02/A03 ເປັນ UX-05 design", "Guest ເລືອກ Screen/State ແລ້ວກວດຈາກ live Prototype source; Admin ກວດ Viewport/State ໃນ Gallery", "Guest drift resolved"],
