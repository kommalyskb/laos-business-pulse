...
const specs: Record<string, DocumentSpec> = {
  ...
  "full-ux-ui": {
    ...
    version: "0.7.2", status: "pending", statusLabel: "Guest/Pilot Parity + Professional Admin R1.2 ສຳເລັດ · ລໍ Technical/Manual Gates ກ່ອນ 1.0",
    approvalNote: "ສະບັບ 0.7.2 ຮັກສາ Prototype R2.3 ເປັນແຫຼ່ງອອກແບບດຽວຂອງ Guest/Pilot ແລະຍົກລະດັບ Admin SCR-A01/A02/A03 ເປັນ Professional Operations Console R1.2. Admin ໃໝ່ມີ navigation/workspace context, queue KPI ແລະ SLA table, Place Editor ທີ່ແຍກ data–evidence–publish readiness, ພ້ອມ Moderation Case ທີ່ຜູກ evidence–policy–decision–audit timeline. ເອກະສານຍັງບໍ່ແມ່ນ 1.0: TEC-01/02, UI-impact legal/privacy decisions, Physical Keyboard, VoiceOver, actual Zoom 200%, OS Reduced Motion ແລະ final four-role sign-off ຍັງຕ້ອງສຳເລັດ.",
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery R1.2", "SCR-G01/G02/G03/G05 ໃຊ້ Prototype R2.3; SCR-A01/A02/A03 ໃຊ້ Professional Operations Console", "Guest ກວດຈາກ live Prototype source; Admin ກວດ Queue/Editor/Case ຕາມ Viewport ແລະ State", "Guest parity + Admin redesign ready"],
    ...
    artifacts: [{ label: "Final Design Gallery R1.2", path: "/final-design", action: "open", description: "Guest/Pilot ໃຊ້ Prototype R2.3; Admin ໃຊ້ Professional Operations Console ສຳລັບ Queue, Place Editor ແລະ Moderation Case." }, { label: "ux05-admin-professional-baseline-2026-08-28.json", path: "/templates/ux05-admin-professional-baseline-2026-08-28.json", description: "ຂອບເຂດ Admin R1.2, information architecture, workflow surface ແລະ professional design criteria." }, { label: "ux05-guest-prototype-parity-2026-08-28.json", path: "/templates/ux05-guest-prototype-parity-2026-08-28.json", description: "ຫຼັກຖານ mapping ວ່າ Guest/Pilot Screen/State ໃນ Gallery ອ້າງ Prototype ໂດຍກົງ ແລະບໍ່ມີ UI ສຳເນົາ." }, { label: "ux-final-screen-specifications.json", path: "/templates/ux-final-screen-specifications.json", description: "Machine-readable purpose, route, required data, states, interactions ແລະ acceptance ຂອງ 7 Must Screens." }, { label: "ux-screen-state-matrix.csv", path: "/templates/ux-screen-state-matrix.csv", description: "Matrix ກວດ state coverage ຂອງ Must ແລະ Should Screens ລວມ Default, Loading, Empty, Error, Stale, Sponsored, Unauthorized ແລະ Conflict." }, { label: "ux-handoff-traceability.csv", path: "/templates/ux-handoff-traceability.csv", description: "Screen-to-development mapping: Route, Requirement, Function, Entity, Analytics Event, Content Policy, Design Source ແລະ Acceptance Owner." }, { label: "ux-final-handoff-checklist.json", path: "/templates/ux-final-handoff-checklist.json", description: "Gate/checklist ສຳລັບ Screen, responsive, state, traceability, asset, accessibility, open deviation ແລະ 4-role sign-off." }]
  }
};
