...
const specs: Record<string, DocumentSpec> = {
  ...
  "full-ux-ui": {
    ...
    version: "0.8.0", status: "pending", statusLabel: "Guest/Pilot Parity + Admin Business Operations Portal R2 ສຳເລັດ · ລໍ Technical/Manual Gates ກ່ອນ 1.0",
    approvalNote: "ສະບັບ 0.8.0 ຮັກສາ Prototype R2.3 ເປັນແຫຼ່ງອອກແບບດຽວຂອງ Guest/Pilot ແລະຂະຫຍາຍ Admin ຈາກ Operations Console 3 ໜ້າເປັນ Business Operations Portal 360° ຈຳນວນ 10 Modules. Portal ຄຸ້ມຄອງ Executive Overview, Work Queue, Place 360, Trust & Safety, Content & Sources, Partners, Campaigns, Analytics, Revenue & Finance ແລະ System & Access. UX ປັບໃຊ້ແນວທາງ Odoo 19 ເຊັ່ນ App Launcher, module workspace, search/filter/group by, list/kanban/analytics views, record activity ແລະ drill-down ໂດຍບໍ່ສຳເນົາ brand ຫຼື proprietary screen ຂອງ Odoo. ເອກະສານຍັງບໍ່ແມ່ນ 1.0: TEC-01/02, UI-impact legal/privacy decisions, Physical Keyboard, VoiceOver, actual Zoom 200%, OS Reduced Motion ແລະ final four-role sign-off ຍັງຕ້ອງສຳເລັດ.",
    ...
    sections: [
      { title: "Final Design Baseline R1 · ສິ່ງທີ່ສຳເລັດແລ້ວ", intro: "Final Design Gallery ແມ່ນ Web Documentation ສຳລັບກວດໜ້າຕາ, hierarchy, responsive direction ແລະ failure state. ມັນບໍ່ແມ່ນ Production application ແລະບໍ່ສ້າງ business logic ແຍກຈາກ PRO-02/04.", headers: ["Deliverable", "ຂອບເຂດ", "ວິທີກວດ", "ສະຖານະ"], rows: [
        ["Final Design Gallery R2", "SCR-G01/G02/G03/G05 ໃຊ້ Prototype R2.3; SCR-A00—A09 ໃຊ້ Admin Business Operations Portal", "Guest ກວດຈາກ live Prototype source; Admin ກວດ 10 Modules, Viewport, State, App Launcher ແລະ cross-module navigation", "Guest parity + Admin Portal R2 ready"],
      ...
      { title: "Approval Gates ແລະ Sign-off", intro: "UX-05 1.0 ແມ່ນຄຳຢືນຢັນວ່າ package ພ້ອມໃຫ້ Developer ສ້າງໂດຍບໍ່ເດົາ. ການມີຮູບ Happy path ສວຍງາມບໍ່ພຽງພໍ.", headers: ["Gate", "ຕ້ອງມີ", "Signer", "ສະຖານະ"], rows: [
        ...
        ["G-UX6 Final handoff", "final screens, responsive/state variants, assets, copy, annotations, open deviations", "Product Owner + Frontend Lead", "Admin Portal R2 baseline ready; final four-role sign-off pending"]
