...
const specs: Record<string, DocumentSpec> = {
  ...
  "interactive-prototype": {
    ...
    version: "0.9.3", status: "pending", statusLabel: "Prototype R2.2 ມີ QA Test Mode · ລໍຜົນທົດສອບຈິງ",
    approvalNote: "Founder Review R2 ວັນທີ 28 ສິງຫາ 2026 ຜ່ານທັງ 5 ຂໍ້ ແລະ Minor Revision ເພີ່ມຮູບເມນູສຳເລັດໃນ R2.1. Prototype R2.2 ເພີ່ມ UX-04 QA Test Mode ໃຫ້ເປີດ Loading, Empty, Error, Disabled, Sponsored, Stale ແລະ Lao long-text ໄດ້ໂດຍກົງ ພ້ອມ Checklist ບັນທຶກ Pass/Fail. UX-03 ຍັງບໍ່ແມ່ນ 1.0 ເພາະ external usability evidence ຈາກຜູ້ໃຊ້ 5 ຄົນຍັງບໍ່ທັນເລີ່ມ.",
    ...
    sections: [
      { title: "ເລີ່ມຈາກນີ້ · ສະຖານະ ແລະວຽກຕໍ່ໄປ", intro: "Founder Review R2 ສຳເລັດແລ້ວ. ຕາຕະລາງນີ້ບອກວ່າອັນໃດສຳເລັດ ແລະອັນໃດຍັງລໍ.", headers: ["ລຳດັບ", "ວຽກ", "ຜົນ", "ສະຖານະ"], rows: [
        ...
        ["3", "ເພີ່ມ UX-04 QA Test Mode", "Prototype R2.2 ມີ Screen/State selector, ຄູ່ມື Keyboard/VoiceOver/Lao 200%/Reduced Motion ແລະ Pass/Fail checklist", "ສຳເລັດ · ຍັງບໍ່ນັບເປັນຜົນ QA"],
        ["4", "Formative test ກັບຜູ້ໃຊ້ພາຍນອກ 5 ຄົນ", "ໃຊ້ Prototype R2.2 ແລະຊຸດແບບຟອມທີ່ກຽມໄວ້", "ຍັງບໍ່ເລີ່ມ"]
      ], note: "Prototype ມີທາງເຂົ້າກວດ failure/accessibility state ແລ້ວ. ຂັ້ນຕໍ່ໄປຄືລົງມືທົດສອບຈິງ, ເກັບຫຼັກຖານ ແລະ recruit ຜູ້ໃຊ້ 5 ຄົນ; ຫ້າມຖືວ່າ Test Mode ເທົ່າກັບຜ່ານ Test."},
      ...
      { title: "Formative Round 1 · ແຜນປະຕິບັດ 5 ຄົນ", intro: "ຮອບນີ້ເນັ້ນຫາບັນຫາຫຼັກກ່ອນ validation 20 ຄົນ. ຕ້ອງ recruit ຜູ້ໃຊ້ຈິງ; ການກວດດ້ວຍ Browser ຫຼືທີມພັດທະນາບໍ່ນັບເປັນ participant.", headers: ["ລຳດັບ", "ການດຳເນີນງານ", "ຜູ້ຮັບຜິດຊອບ", "ຫຼັກຖານ/Exit"], rows: [
        ...
        ["F-06 Status boundary", "ຊຸດເອກະສານ ແລະ Prototype R2.2 ພ້ອມສຳລັບ recruitment ແຕ່ຍັງບໍ່ມີ real-user result.", "Product Owner", "UX-03 ຄົງ 0.9.3 ຈົນ evidence ແລະ pass gate ຄົບ"]
      ]}
    ],
  ...
  "design-system": {
    ...
    sections: [
      ...
      { title: "Pilot Component Catalog", intro: "ລາຍການນີ້ກົງກັບ Prototype R2.2. ແຕ່ລະ Component ຕ້ອງອ້າງ Place ID ຫຼື Search State ດຽວກັນ ເພື່ອບໍ່ໃຫ້ Video, List ແລະ Map ສະແດງຂໍ້ມູນຂັດກັນ.", headers: ["ID / Component", "ໜ້າທີ່", "ຂໍ້ມູນ/ສ່ວນປະກອບ", "ພຶດຕິກຳ ແລະເກນຮັບມອບ"], rows: [
      ...
      { title: "Accessibility QA Evidence · 28 Aug 2026", intro: "ຕາຕະລາງນີ້ແຍກສິ່ງທີ່ກວດຜ່ານແລ້ວອອກຈາກສິ່ງທີ່ຍັງຕ້ອງກວດ. ຫ້າມນັບ Browser QA ຫຼືການມີ Code ເປັນຫຼັກຖານວ່າ Manual Accessibility Test ຜ່ານ.", headers: ["QA ID", "ການກວດ", "ຜົນ", "ສະຖານະ"], rows: [
        ...
        ["A11Y-05", "Reduced motion", "Prototype R2.2 ມີຄຳແນະນຳ ແລະ CSS ປິດ non-essential animation ເມື່ອ OS ເປີດ Reduce Motion", "Test surface ready · manual evidence pending"],
        ["A11Y-06", "Lao text 200%", "Prototype R2.2 ມີ Lao long-text scenario; ຕ້ອງຕັ້ງ Zoom 200% ແລະກວດ Discover/Search/Place/Consent ຈິງ", "Test surface ready · blocks 1.0"],
        ["A11Y-07", "VoiceOver", "Prototype R2.2 ມີຂັ້ນຕອນ Discover → Search → Place; ຕ້ອງກວດ landmark, heading, label, dialog ແລະ status ດ້ວຍ VoiceOver ຈິງ", "Test surface ready · blocks 1.0"],
        ["A11Y-08", "NVDA", "ກວດ Windows Screen Reader ກ່ອນ Public/Wider Launch", "Deferred · does not block Pilot 1.0"],
        ["A11Y-09", "Pilot Guest Component States", "Default/Loading/Empty/Error/Disabled/Sponsored/Stale ເປີດໄດ້ຈາກ UX-04 QA Test Mode ໃນ Prototype R2.2 ແລະ Gallery", "Test surface ready · manual result pending"],
  ...
  "full-ux-ui": {
    ...
    sources: ["UX-01 1.0", "UX-02 1.2", "UX-03 0.9.3", "UX-04 0.9.3", "PRO-04 0.9", "CON-01 0.9", "CON-02 1.0", "CON-03 0.9", "CON-04 1.0", "CON-05 0.9", "TEC-01/02 pending"],
  ...
  return <article className={`${styles.detailBody} ${styles.formalDocument}`}>
    ...
    <section className={styles.formalSection} id="document-control"><h2><span>1.</span> ຂໍ້ມູນຄວບຄຸມເອກະສານ</h2>
      ...
      <div className={styles.formalTableWrap}><table className={styles.formalTable}><thead><tr><th>ສະບັບ</th><th>ວັນທີ</th><th>ລາຍລະອຽດ</th><th>ສະຖານະ</th></tr></thead><tbody>
        ...
        {spec.version ? <tr><td>{version}</td><td>{documentDate}</td><td>{slug === "ux-ui-wireframe" ? "ບັນທຶກ Founder Review R1/R2, ປັບ Search/Place direction ແລະເພີ່ມຮູບເມນູໃນ Prototype R2.1" : slug === "interactive-prototype" ? "ອັບເດດ Prototype R2.2 ໃຫ້ມີ UX-04 QA Test Mode, deterministic states, Lao long-text ແລະ session-only Pass/Fail checklist" : slug === "design-system" ? "ເພີ່ມ Product-flow QA Test Mode ແລະ Evidence Template; Manual Accessibility Test ຍັງເປັນ Gate ກ່ອນ 1.0" : "ບັນທຶກ REV-01 ຫາ REV-05 ແລະປັບ Policy, Threshold ແລະ Ownership ຕາມທີ່ອະນຸມັດ"}</td><td>{statusLabel}</td></tr> : null}
      </tbody></table></div>
    </section>
