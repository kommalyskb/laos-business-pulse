...
export default function FinalDesignGallery({ basePath }: { basePath: string }) {
  ...
  return <main className={styles.site}>
    <header className={styles.topbar}><a href={`${basePath}/documents/full-ux-ui`}><b>UX-05</b><span>FINAL DESIGN GALLERY</span></a><nav><a href={`${basePath}/prototype`}>Guest Prototype R2.3</a><a href={`${basePath}/admin-prototype`}>Admin Prototype R4.1</a><a href={`${basePath}/design-system`}>UX-04 Gallery</a><a href={`${basePath}/documents`}>Documents</a></nav></header>
    <section className={styles.hero}><div><small>FULL UX/UI DESIGN · BASELINE 0.10.1</small><h1>ໜ້າຈໍສຳລັບຕັດສິນໃຈ<br/><em>ແລະພ້ອມທົດລອງ Workflow</em></h1></div><p>Guest/Pilot ໃຊ້ Prototype R2.3 ເປັນແຫຼ່ງອອກແບບດຽວ. Admin R4.1 ມີ 10 Main Modules ແລະ 55 functional views. Content intake ຖືກປັບໃຫ້ task-first: ຜູ້ໃຊ້ເລືອກເພີ່ມ Place ຫຼື Review Source ໄດ້ໂດຍກົງ ແລະເຫັນ Place → Link → Rights → Publish ກ່ອນເລີ່ມ.</p></section>
